...
class AccountingController extends Controller
{
    ...
    public function summaryRentedVehicle(Request $request)
    {
        ...
        // Default to Apr '26 - Sep '26 or current 6-month window
        $startMonth = $request->input('start_month', '2026-04');
        $endMonth = $request->input('end_month', '2026-09');
        ...
        return view('accounting.summary_rented_vehicle', [
            ...
            'endMonth' => $endMonth,
            'excludeOthersLt' => $excludeOthersLt,
            'search' => $search,
