...
<div class="space-y-6" x-data="{ showModal: false, editMode: false, form: { id: null, name: '', email: '', password: '', branch: 'ALL', role: 'branch_user', menu_permissions: ['dashboard', 'total-stock', 'rental-pairs', 'in-stock', 'active-rentals', 'in-service'] } }">
    ...
    <div x-show="showModal" style="display: none;" class="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-900/40 dark:bg-slate-950/90 backdrop-blur-md dark:backdrop-blur-xl" x-transition>
        <div @click.away="showModal = false" class="bg-white dark:bg-[#0d1322] border border-slate-200 dark:border-slate-700/80 rounded-3xl p-7 w-full max-w-xl shadow-2xl dark:shadow-[0_0_60px_rgba(0,0,0,0.95)] space-y-6 relative text-slate-900 dark:text-slate-100 transition-all">
            
            <!-- Modal Title Bar -->
            <div class="flex items-center justify-between border-b border-slate-200 dark:border-slate-800/80 pb-4">
                <div class="flex items-center gap-3">
                    <div class="w-10 h-10 rounded-2xl bg-gradient-to-br from-indigo-500/10 to-cyan-500/10 dark:from-indigo-500/20 dark:to-cyan-500/20 border border-indigo-500/20 dark:border-indigo-500/30 flex items-center justify-center text-indigo-600 dark:text-indigo-400 shadow-inner">
            ...
            <form :action="editMode ? '{{ url('/settings/users') }}/' + form.id : '{{ route('users.store') }}'" method="POST" class="space-y-5">
                ...
                <div class="space-y-1.5">
                    ...
                    <input type="email" name="email" x-model="form.email" required placeholder="name@harent.co.id" class="w-full px-4 py-3 rounded-2xl bg-slate-50 dark:bg-[#050913] border border-slate-300 dark:border-slate-700/80 text-slate-900 dark:text-white text-xs font-semibold focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 focus:outline-none transition-all placeholder:text-slate-400 dark:placeholder:text-slate-600">
                </div>
                ...
                <div class="space-y-1.5">
                    <label class="text-[11px] font-bold text-slate-700 dark:text-slate-300 uppercase tracking-wider flex items-center gap-1.5 justify-between">
                        ...
                        <span x-show="editMode" class="text-[10px] text-slate-500 dark:text-slate-400 lowercase font-normal">(leave blank to keep unchanged)</span>
                    </label>
                    <input type="password" name="password" :required="!editMode" placeholder="••••••••" class="w-full px-4 py-3 rounded-2xl bg-slate-50 dark:bg-[#050913] border border-slate-300 dark:border-slate-700/80 text-slate-900 dark:text-white text-xs font-semibold focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 focus:outline-none transition-all placeholder:text-slate-400 dark:placeholder:text-slate-600">
                </div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="space-y-1.5">
                        ...
                        <select name="role" x-model="form.role" class="w-full px-4 py-3 rounded-2xl bg-slate-50 dark:bg-[#050913] border border-slate-300 dark:border-slate-700/80 text-slate-900 dark:text-white text-xs font-semibold focus:border-indigo-500 focus:outline-none cursor-pointer">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <select name="branch" x-model="form.branch" class="w-full px-4 py-3 rounded-2xl bg-slate-50 dark:bg-[#050913] border border-slate-300 dark:border-slate-700/80 text-slate-900 dark:text-white text-xs font-semibold focus:border-indigo-500 focus:outline-none cursor-pointer">
                ...
                <div class="space-y-2 pt-1">
                    ...
                    <div class="grid grid-cols-2 gap-2 text-xs p-3 rounded-2xl bg-slate-50 dark:bg-[#050913] border border-slate-200 dark:border-slate-800">
                        <label class="flex items-center gap-2.5 p-2 rounded-xl hover:bg-slate-200/50 dark:hover:bg-slate-900 cursor-pointer transition-colors text-slate-800 dark:text-slate-200">
                        ...
                        <label class="flex items-center gap-2.5 p-2 rounded-xl hover:bg-slate-200/50 dark:hover:bg-slate-900 cursor-pointer transition-colors text-slate-800 dark:text-slate-300">
                            ...
                            <div class="flex items-center justify-between w-full">
                                ...
                                <span class="text-[9px] font-bold px-1.5 py-0.5 rounded bg-indigo-100 text-indigo-700 dark:bg-indigo-500/20 dark:text-indigo-300 border border-indigo-200 dark:border-indigo-500/30">JKT/IT</span>
                            </div>
                        </label>
                        <label class="flex items-center gap-2.5 p-2 rounded-xl hover:bg-slate-200/50 dark:hover:bg-slate-900 cursor-pointer transition-colors text-slate-800 dark:text-slate-300">
                            ...
                            <div class="flex items-center justify-between w-full">
                                ...
                                <span class="text-[9px] font-bold px-1.5 py-0.5 rounded bg-purple-100 text-purple-700 dark:bg-purple-500/20 dark:text-purple-300 border border-purple-200 dark:border-purple-500/30">JKT/IT</span>
                            </div>
                        </label>
                    </div>
                </div>
                ...
                <!-- Footer Buttons -->
                <div class="flex items-center justify-end gap-3 border-t border-slate-200 dark:border-slate-800/80 pt-5 mt-6">
