    ...
    <div class="flex min-h-screen">
        ...
        <aside 
            ...
            <nav class="p-4 space-y-1 flex-1 overflow-y-auto overflow-x-hidden custom-scrollbar">
                ...
                <a href="{{ route('crm.index') }}" class="sidebar-link flex items-center gap-3 px-4 py-3 rounded-xl text-slate-600 hover:bg-slate-50 hover:text-indigo-600 transition-all group {{ request()->routeIs('crm.index') ? 'active' : '' }}"
                   title="CRM">
