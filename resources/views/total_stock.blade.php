...
<div x-data="queryBuilder()" x-init="init()" class="h-[calc(100vh-140px)] flex flex-col max-w-[1600px] mx-auto w-full gap-4 relative">
    ...
    <div x-show="traceabilityModal.open" x-cloak 
         ...
         class="fixed inset-0 z-[9999] p-4 flex items-center justify-center bg-black/60 backdrop-blur-sm" @keydown.escape.window="traceabilityModal.open = false">
    ...
    function queryBuilder() {
        return {
            ...
            columns: {
                ...
                purchase_date: { label: 'Purc. Date', visible: true, width: 100 },
